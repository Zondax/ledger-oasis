...
- Ledger Nano X/Flex/Apex BOLOS app
- Specs / Documentation
- C++ unit tests
- Rust unit tests
- Zemu tests
...
Download a release from here (https://github.com/Zondax/ledger-oasis/releases). You will need the appropriate installer for your device.
...
- Upload to a device
   ...
   _Warning: The application will be deleted before uploading.
