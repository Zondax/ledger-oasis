...
describe("Standard-Adr0008-0", function () {
  ...
  test.concurrent.each(models)("main menu", async function (m) {
    ...
    try {
      ...
      await sim.navigateAndCompareSnapshots(
        ".",
        `${m.prefix.toLowerCase()}-adr0008-0-mainmenu`,
  ...
  test.concurrent.each(models)("get address", async function (m) {
    ...
    try {
      ...
      const expected_bech32_address =
        "oasis1qqjkrr643qv7yzem6g4m8rrtceh42n46usfscpcf";
      const expected_pk =
        "45601f761af17dba50243529e629732f1c58d08ffddaa8491238540475729d85";
  ...
  test.concurrent.each(models)("sign basic - withdraw", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-adr0008-0-sign_basic_withdraw`,
      );
  ...
  test.concurrent.each(models)("sign basic - allow", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-adr0008-0-sign_basic_allow`,
      );
  ...
  test.concurrent.each(models)("sign basic", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-adr0008-0-sign_basic`,
      );
  ...
  test.concurrent.each(models)("submit proposal - upgrade", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-adr0008-0-submit_proposal_upgrade`,
      );
  ...
  test.concurrent.each(models)(
    ...
    async function (m) {
      ...
      try {
        ...
        await sim.compareSnapshotsAndApprove(
          ".",
          `${m.prefix.toLowerCase()}-adr0008-0-submit_proposal_cancel_upgrade`,
        );
  ...
  test.concurrent.each(models)("add escrow", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-adr0008-0-add_escrow`,
      );
  ...
  test.concurrent.each(models)("reclaim escrow", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-adr0008-0-reclaim_escrow`,
      );
  ...
  test.concurrent.each(models)("transfer", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-adr0008-0-transfer`,
      );
  ...
  test.concurrent.each(models)("cast vote - abstain", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-adr0008-0-cast_vote_abstain`,
      );
  ...
  test.concurrent.each(models)("cast vote - yes", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-adr0008-0-cast_vote_yes`,
      );
  ...
  test.concurrent.each(models)("cast vote - no", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-adr0008-0-cast_vote_no`,
      );
  ...
  test.concurrent.each(models)("sign amend schedule", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-adr0008-0-sign_amend`,
        true,
      );
  ...
  test.concurrent.each(models)(
    ...
    async function (m) {
      ...
      try {
        ...
        await sim.compareSnapshotsAndApprove(
          ".",
          `${m.prefix.toLowerCase()}-adr0008-0-sign_amend_issue_130`,
          true,
        );
  ...
  test.concurrent.each(models)("sign entity metadata", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-adr0008-0-sign_entity_metadata`,
      );
  ...
  test.concurrent.each(models)(
    ...
    async function (m) {
      ...
      try {
        ...
        await sim.compareSnapshotsAndApprove(
          ".",
          `${m.prefix.toLowerCase()}-adr0008-0-sign_register_entity`,
        );
  ...
  test.concurrent.each(models)("sign entity descriptor", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-adr0008-0-sign_entity_descriptor`,
      );
  ...
  test.concurrent.each(models)(
    ...
    async function (m) {
      ...
      try {
        ...
        await sim.compareSnapshotsAndApprove(
          ".",
          `${m.prefix.toLowerCase()}-adr0008-0-sign_register_entity_no_nodes`,
        );
  ...
  test.concurrent.each(models)(
    ...
    async function (m) {
      ...
      try {
        ...
        await sim.compareSnapshotsAndApprove(
          ".",
          `${m.prefix.toLowerCase()}-adr0008-0-sign_entity_metadata_utf8`,
        );
  ...
  test.concurrent.each(models)(
    ...
    async function (m) {
      ...
      try {
        ...
        await sim.compareSnapshotsAndApprove(
          ".",
          `${m.prefix.toLowerCase()}-adr0008-0-sign_entity_metadata_long`,
        );
