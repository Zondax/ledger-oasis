...
describe('Standard-Adr0008-5', function () {
  ...
  test.each(models)('sign amend schedule - issue #130', async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndAccept(".", `${m.prefix.toLowerCase()}-adr0008-5-sign_amend_issue_130`, m.name === "nanos" ? 29 : 30);
  ...
  test.each(models)('sign entity register', async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndAccept(".", `${m.prefix.toLowerCase()}-adr0008-5-sign_entity_register`, m.name === "nanos" ? 24 : 24);
  ...
  test.each(models)('sign entity descriptor', async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndAccept(".", `${m.prefix.toLowerCase()}-adr0008-5-sign_entity_descriptor`, m.name === "nanos" ? 1 : 1);
