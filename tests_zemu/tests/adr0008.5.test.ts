...
describe('Standard-Adr0008-5', function () {
  ...
  test.concurrent.each(models)('main menu', async function (m) {
    ...
    try {
      ...
      await sim.start({ ...defaultOptions, model: m.name })
      await sim.navigateAndCompareSnapshots('.', `${m.prefix.toLowerCase()}-adr0008-5-mainmenu`, mainmenuNavigation.schedule)
    } finally {
      await sim.close()
    }
  })
  ...
  test.concurrent.each(models)('show address', async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-adr0008-5-show_address`)
  ...
  test.concurrent.each(models)('sign basic - withdraw', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-adr0008-5-sign_basic_withdraw`)
  ...
  test.concurrent.each(models)('sign basic - allow', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-adr0008-5-sign_basic_allow`)
  ...
  test.concurrent.each(models)('sign basic', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-adr0008-5-sign_basic`)
  ...
  test.concurrent.each(models)('submit proposal - upgrade', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-adr0008-5-submit_proposal_upgrade`)
  ...
  test.concurrent.each(models)('submit proposal - cancel upgrade', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-adr0008-5-submit_proposal_cancel_upgrade`)
  ...
  test.concurrent.each(models)('add escrow', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-adr0008-5-add_escrow`)
  ...
  test.concurrent.each(models)('reclaim escrow', async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-adr0008-5-reclaim_escrow`)
  ...
  test.concurrent.each(models)('transfer', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-adr0008-5-transfer`)
  ...
  test.concurrent.each(models)('cast vote - abstain', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-adr0008-5-cast_vote_abstain`)
  ...
  test.concurrent.each(models)('cast vote - yes', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-adr0008-5-cast_vote_yes`)
  ...
  test.concurrent.each(models)('cast vote - no', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-adr0008-5-cast_vote_no`)
  ...
  test.concurrent.each(models)('sign amend schedule', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-adr0008-5-sign_amend`, true)
  ...
  test.concurrent.each(models)('sign amend schedule - issue #130', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-adr0008-5-sign_amend_issue_130`, true)
  ...
  test.concurrent.each(models)('sign entity metadata', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-adr0008-5-sign_entity_metadata`)
  ...
  test.concurrent.each(models)('sign register entity with nodes', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-adr0008-5-sign_register_entity`)
  ...
  test.concurrent.each(models)('sign entity descriptor', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-adr0008-5-sign_entity_descriptor`)
  ...
  test.concurrent.each(models)('sign register entity without nodes', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-adr0008-5-sign_register_entity_no_nodes`)
  ...
  test.concurrent.each(models)('sign deregister entity', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-adr0008-5-sign_deregister_entity`)
  ...
  test.concurrent.each(models)('sign entity metadata - utf8', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-adr0008-5-sign_entity_metadata_utf8`)
  ...
  test.concurrent.each(models)('sign entity metadata - long url', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-adr0008-5-sign_entity_metadata_long`)
...
describe('Issue #68', function () {
  test.concurrent.each(models)('should sign a transaction two time in a row (issue #68)', async function (m) {
    ...
    try {
      ...
      await Zemu.sleep(1000) // Increase from 500ms to 1000ms
