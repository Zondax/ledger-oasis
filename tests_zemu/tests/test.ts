...
describe('Standard', function () {
  ...
  test.concurrent.each(models)('get Ed25519 address', async function (m) {
    const sim = new Zemu(m.path)
    try {
      await sim.start({
        ...defaultOptions,
  ...
  test.concurrent.each(models)('show Ed25519 address', async function (m) {
    const sim = new Zemu(m.path)
    try {
      await sim.start({
        ...defaultOptions,
  ...
  test.concurrent.each(models)('sign basic - withdraw', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-sign_basic_withdraw`)
  ...
  test.concurrent.each(models)('sign basic - allow', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-sign_basic_allow`)
  ...
  test.concurrent.each(models)('submit proposal - upgrade', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-submit_proposal_upgrade`)
  ...
  test.concurrent.each(models)('submit proposal - cancel upgrade', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-submit_proposal_cancel_upgrade`)
  ...
  test.concurrent.each(models)('add escrow', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-add_escrow`)
  ...
  test.concurrent.each(models)('reclaim escrow', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-reclaim_escrow`)
  ...
  test.concurrent.each(models)('transfer', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-transfer`)
  ...
  test.concurrent.each(models)('cast vote - abstain', async function (m) {
    ...
    try {
      ...
      const context = 'oasis-core/consensus: tx for chain 31baebfc917e608ab5d26d8e072d70627cdef4df342b98bb61fe3683e4e4b2ac'
      const txBlob = Buffer.from('pGNmZWWiY2dhcwBmYW1vdW50QGRib2R5omJpZABkdm90ZQNlbm9uY2UBZm1ldGhvZHNnb3Zlcm5hbmNlLkNhc3RWb3Rl', 'base64')
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-cast_vote_abstain`)
  ...
  test.concurrent.each(models)('cast vote - yes', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-cast_vote_yes`)
  ...
  test.concurrent.each(models)('cast vote - no', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-cast_vote_no`)
  ...
  test.concurrent.each(models)('sign basic - invalid', async function (m) {
    ...
    try {
      ...
      invalidMessage = Buffer.concat([invalidMessage as unknown as Uint8Array, Buffer.from('1') as unknown as Uint8Array])
  ...
  test.concurrent.each(models)('sign amend schedule', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-sign_amend`, true)
  ...
  test.concurrent.each(models)('sign amend schedule - issue #130', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-sign_amend_issue_130`, true)
  ...
  test.concurrent.each(models)('sign entity metadata', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-sign_entity_metadata`)
  ...
  test.concurrent.each(models)('sign entity descriptor', async function (m) {
    ...
    try {
      ...
      const txBlob = Buffer.from('a2617602626964582097e72e6e83ec39eb98d7e9189513aba662a08a210b9974b0f7197458483c7161', 'hex')
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-sign_entity_descriptor`)
  ...
  test.concurrent.each(models)('sign register entity with nodes', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-sign_register_entity`)
  ...
  test.concurrent.each(models)('sign register entity without nodes', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-sign_register_entity_no_nodes`)
  ...
  test.concurrent.each(models)('sign deregister entity', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-sign_deregister_entity`)
  ...
  test.concurrent.each(models)('sign entity metadata - utf8', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-sign_entity_metadata_utf8`)
  ...
  test.concurrent.each(models)('sign entity metadata - long url', async function (m) {
    ...
    try {
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-sign_entity_metadata_long`)
  ...
  test.concurrent.each(models)('sign entity metadata - long name', async function (m) {
    ...
    try {
      ...
      expect(resp.error_message).toEqual('Data is invalid')
    } finally {
      await sim.close()
    }
  })
...
describe('Issue #68', function () {
  ...
  test.concurrent.each(models)('sign basic - testnet', async function (m) {
    const sim = new Zemu(m.path)
    try {
      await sim.start({ ...defaultOptions, model: m.name })
      const app = new OasisApp(sim.getTransport())

      const context = 'oasis-core/consensus: tx for chain 50304f98ddb656620ea817cc1446c401752a05a249b36c9b90dba4616829977a'
      const txBlob = Buffer.from(
        'pGNmZWWiY2dhcwBmYW1vdW50QGRib2R5omtiZW5lZmljaWFyeVUA8PesI5mFWUkMVHwStQ6Fieb4bsFtYW1vdW50X2NoYW5nZUBlbm9uY2UBZm1ldGhvZG1zdGFraW5nLkFsbG93',
        'base64',
      )
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-sign_basic_allow_testnet`)
  ...
  test.concurrent.each(models)('cast vote - yes testnet', async function (m) {
    const sim = new Zemu(m.path)
    try {
      await sim.start({ ...defaultOptions, model: m.name })
      const app = new OasisApp(sim.getTransport())
      ...
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot(), 20000)
      await sim.compareSnapshotsAndApprove('.', `${m.prefix.toLowerCase()}-cast_vote_yes_testnet`)
