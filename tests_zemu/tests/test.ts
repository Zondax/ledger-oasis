...
describe("Standard", function () {
  ...
  test.concurrent.each(models)("sign basic - allow", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-sign_basic_allow`,
      );
  ...
  test.concurrent.each(models)("submit proposal - upgrade", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-submit_proposal_upgrade`,
      );
  ...
  test.concurrent.each(models)(
    ...
    async function (m) {
      ...
      try {
        ...
        await sim.compareSnapshotsAndApprove(
          ".",
          `${m.prefix.toLowerCase()}-submit_proposal_cancel_upgrade`,
        );
  ...
  test.concurrent.each(models)("add escrow", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-add_escrow`,
      );
  ...
  test.concurrent.each(models)("reclaim escrow", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-reclaim_escrow`,
      );
  ...
  test.concurrent.each(models)("cast vote - abstain", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-cast_vote_abstain`,
      );
  ...
  test.concurrent.each(models)("cast vote - yes", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-cast_vote_yes`,
      );
  ...
  test.concurrent.each(models)("cast vote - no", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-cast_vote_no`,
      );
  ...
  test.concurrent.each(models)("sign entity metadata", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-sign_entity_metadata`,
      );
  ...
  test.concurrent.each(models)("sign entity descriptor", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-sign_entity_descriptor`,
      );
  ...
  test.concurrent.each(models)(
    "sign register entity with nodes",
    async function (m) {
      const sim = new Zemu(m.path);
      try {
        await sim.start({ ...defaultOptions, model: m.name });
        ...
        await sim.compareSnapshotsAndApprove(
          ".",
          `${m.prefix.toLowerCase()}-sign_register_entity`,
        );
  ...
  test.concurrent.each(models)(
    "sign register entity without nodes",
    async function (m) {
      const sim = new Zemu(m.path);
      try {
        await sim.start({ ...defaultOptions, model: m.name });
        ...
        await sim.compareSnapshotsAndApprove(
          ".",
          `${m.prefix.toLowerCase()}-sign_register_entity_no_nodes`,
        );
  ...
  test.concurrent.each(models)("sign deregister entity", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-sign_deregister_entity`,
      );
  ...
  test.concurrent.each(models)(
    ...
    async function (m) {
      ...
      try {
        ...
        await sim.compareSnapshotsAndApprove(
          ".",
          `${m.prefix.toLowerCase()}-sign_entity_metadata_utf8`,
        );
  ...
  test.concurrent.each(models)(
    ...
    async function (m) {
      ...
      try {
        ...
        await sim.compareSnapshotsAndApprove(
          ".",
          `${m.prefix.toLowerCase()}-sign_entity_metadata_long`,
        );
  ...
  test.concurrent.each(models)(
    "sign entity metadata - long name",
    async function (m) {
      const sim = new Zemu(m.path);
      try {
        await sim.start({ ...defaultOptions, model: m.name });
...
describe("Issue #68", function () {
  ...
  test.concurrent.each(models)("sign basic - mainnet", async function (m) {
    ...
    try {
      ...
      const context =
        "oasis-core/consensus: tx for chain 53852332637bacb61b91b6411ab4095168ba02a50be4c3f82448438826f23898";
      const txBlob = Buffer.from(
        "pGNmZWWiY2dhcwBmYW1vdW50QGRib2R5omtiZW5lZmljaWFyeVUA8PesI5mFWUkMVHwStQ6Fieb4bsFtYW1vdW50X2NoYW5nZUBlbm9uY2UBZm1ldGhvZG1zdGFraW5nLkFsbG93",
        "base64",
      );
  ...
  test.concurrent.each(models)("cast vote - yes mainnet", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-cast_vote_yes_mainnet`,
      );
  ...
  test.concurrent.each(models)("sign basic - testnet", async function (m) {
    ...
    try {
      ...
      const context =
        "oasis-core/consensus: tx for chain 50304f98ddb656620ea817cc1446c401752a05a249b36c9b90dba4616829977a";
      const txBlob = Buffer.from(
        "pGNmZWWiY2dhcwBmYW1vdW50QGRib2R5omtiZW5lZmljaWFyeVUA8PesI5mFWUkMVHwStQ6Fieb4bsFtYW1vdW50X2NoYW5nZUBlbm9uY2UBZm1ldGhvZG1zdGFraW5nLkFsbG93",
        "base64",
      );
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-sign_basic_allow_testnet`,
      );
  ...
  test.concurrent.each(models)("cast vote - yes testnet", async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndApprove(
        ".",
        `${m.prefix.toLowerCase()}-cast_vote_yes_testnet`,
      );
