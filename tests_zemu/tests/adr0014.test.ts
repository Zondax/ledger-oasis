...
describe("Standard-Adr0014", function () {
  ...
  test.concurrent.each(models)(
    "sign ed25519 consensus - deposit",
    async function (m) {
      const sim = new Zemu(m.path);
      try {
        await sim.start({ ...defaultOptions, model: m.name });
  ...
  test.concurrent.each(models)(
    "sign ed25519 accounts - transfer",
    async function (m) {
      const sim = new Zemu(m.path);
      try {
        await sim.start({ ...defaultOptions, model: m.name });
  ...
  test.concurrent.each(models)(
    "sign ed25519 consensus - withdraw",
    async function (m) {
      const sim = new Zemu(m.path);
      try {
        await sim.start({ ...defaultOptions, model: m.name });
  ...
  test.concurrent.each(models)(
    "sign secp256k1 accounts - transfer",
    async function (m) {
      const sim = new Zemu(m.path);
      try {
        await sim.start({ ...defaultOptions, model: m.name });
  ...
  test.concurrent.each(models)(
    "sign secp256k1 consensus - withdraw",
    async function (m) {
      const sim = new Zemu(m.path);
      try {
        await sim.start({ ...defaultOptions, model: m.name });
  ...
  test.concurrent.each(models)(
    "sign ed25519 runtime - encrypted",
    async function (m) {
      const sim = new Zemu(m.path);
      try {
        await sim.start({ ...defaultOptions, model: m.name });
  ...
  test.concurrent.each(models)("get Sr25519 address", async function (m) {
    ...
    try {
      ...
      const expected_bech32_address =
        "oasis1qr9af6sfg3gmv5nefxkq7k7cxpz48r0wlu2j9frf";
      const expected_pk =
        "bcfd51e4c33347fafdae2732998a4f6c103d26f9a58b1773944616129c791316";
  ...
  test.concurrent.each(models)(
    "sign sr25519 consensus - withdraw",
    async function (m) {
      const sim = new Zemu(m.path);
      try {
        await sim.start({ ...defaultOptions, model: m.name });
  ...
  test.concurrent.each(models)(
    "sign sr25519 runtime - encrypted",
    async function (m) {
      const sim = new Zemu(m.path);
      try {
        await sim.start({ ...defaultOptions, model: m.name });
